  ...
  healthy: buildProofRecord(
    {
      ...
      custody: {
        url: "https://example.com/aiif-custody-2026-q1.pdf",
      ...
      valuation: {
        url: "https://example.com/aiif-valuation-2025-dec.pdf",
      ...
      legal: {
        url: "https://example.com/aiif-sfc-filing.pdf",
      ...
      regulatory: {
        url: "https://example.com/aiif-sfc-registration.pdf",
  ...
  review: buildProofRecord(
    {
      ...
      custody: {
        url: "https://example.com/sgot-custody-q1-2026.pdf",
      ...
      valuation: {
        url: "https://example.com/sgot-valuation-2025.pdf",
  ...
  "at-risk": buildProofRecord(
    {
      ...
      custody: {
        url: "https://example.com/dlwf-custody-2025.pdf",
      ...
      legal: {
        url: "https://example.com/dlwf-difc-filing.pdf",
      ...
      regulatory: {
        url: "https://example.com/dlwf-dfsa-registration.pdf",
